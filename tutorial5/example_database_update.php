...
<div id="wrap">
  ...
  <div id="content-wrap">
    ...
    <div id="main"> <a name="ReadDatabase"></a>
      <h1>Example: update data in a database</h1>
	  <h3>Code</h3>
      <p><code> &lt;?php <br />
				...
				&lt;?php <br />
					...
					&nbsp;&nbsp; $employeeNumber = 1002; <br />
					&nbsp;&nbsp; $officeCode = 2;	 <br />
					 <br />
					&nbsp;&nbsp; // 2. Perform database query <br />
					&nbsp;&nbsp; $query  = "UPDATE employees SET "; <br />
					&nbsp;&nbsp; $query .= "officeCode = {$officeCode} ";	 <br />
					&nbsp;&nbsp; $query .= "WHERE employeeNumber = {$employeeNumber}"; <br />
					<br />
					&nbsp;&nbsp; $result = mysqli_query($connection, $query); <br />
					<br />
					&nbsp;&nbsp; if ($result && mysqli_affected_rows($connection) == 1) { <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// Success <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// redirect_to("somepage.php"); <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	echo "Success!"; <br />
					&nbsp;&nbsp; } else { <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// Failure <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// $message = "Subject update failed"; <br />
