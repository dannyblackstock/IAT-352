    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if (filesize("user_info.txt") > 0) {
                ...
                $userDataString = "\n".($lastUserID+1)." | ".$name." | ".$email." | ".$password." | ".$profilePicture." | ".$highschool." | ".$graduationYear." | ".$bio;

            }

            else {
                $userDataString = "1 | ".$name." | ".$email." | ".$password." | ".$profilePicture." | ".$highschool." | ".$graduationYear." | ".$bio;
