...
<div id="wrap">
  ...
  <div id="content-wrap">
    ...
    <div id="main"> <a name="ReadDatabase"></a>
      <h1>Example: insert data to a database</h1>
	  <h3>Code</h3>
      <p><code> &lt;?php <br />
				...
				&lt;?php <br />
					...
					&nbsp;&nbsp; $customerNumber = (int) 247; <br />
					&nbsp;&nbsp; $amount = (double) 432.45; <br />
					&nbsp;&nbsp; $paymentDate = '2014-01-27'; <br />
					&nbsp;&nbsp; $checkNumber = 'abc-002'; <br />		
					<br />	
					&nbsp;&nbsp; // 2. Perform database query  <br />
					&nbsp;&nbsp; $query  = "INSERT INTO payments ("; <br />
					&nbsp;&nbsp; $query .= "  amount, checkNumber, customerNumber, paymentDate"; <br />
					&nbsp;&nbsp; $query .= ") VALUES ("; <br />
					&nbsp;&nbsp; $query .= "  {$amount}, '{$checkNumber}', {$customerNumber}, '{$paymentDate}'"; <br />
					&nbsp;&nbsp; $query .= ")"; <br />
					<br />
					...
					&nbsp;&nbsp; } else { <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// Failure <br />
					&nbsp;&nbsp; &nbsp;&nbsp; 	// $message = "Subject creation failed"; <br />
